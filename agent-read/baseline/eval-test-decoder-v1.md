# Eval Test Decoder V1

这份文档记录 2026-03-15 在当前工作区完成的一次完整 RoboTwin 评测与 latent 解码实验。目标是把三件事一次跑通：
...
- `/home/zaijia001/vam/lingbot-va/evaluation/robotwin/decode_saved_latents.py`
...
- `/home/zaijia001/vam/lingbot-va/wan_va/wan_va_server.py`
...
- `comparison_video_path`、`eval_video_path`、`latent_decode_video_path` 现在都按绝对路径/可追踪路径记录
...
- client 记录绝对/可确定基准的 artifact 路径
